...
fun polynom(p: List<Int>, x: Int): Int =
    p.foldRight(0) { element, previousResult -> previousResult * x + element }
...
fun russian(n: Int): String =
    (n100(n / 1000) + n10(n / 1000 % 100) + n1(n / 1000 % 10) + n1000(n) + n100(n) + n10(n) + n1(n)).trim()
...
fun n1(x: Int): String {
    ...
    val p100 = x % 100
    return if (p100 < 20) list[p100] else list[p100 % 10]
}
